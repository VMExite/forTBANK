...
class StackoverflowLinkExecutorTest {
    ...
    void testGreenAnswerAndComments() {
        ...
        when(client.getQuestion(123L)).thenReturn(
            new StackExchangeResponse<>(
                List.of(
        ...
        when(client.getAnswers(123L)).thenReturn(
            new StackExchangeResponse<>(
                List.of(
        ...
        when(client.getComments("10")).thenReturn(
            new StackExchangeResponse<>(
                List.of(
        ...
        when(client.getComments("123")).thenReturn(
            new StackExchangeResponse<>(
                List.of(
                    new StackOverflowCommentResponse(
                        2L,
